    ...
    return __awaiter(void 0, __spreadArray([editor_1], args_1, true), void 0, function (editor, opts) {
        ...
        function showOstToolbar(listItem) {
            ...
            if (ostToolbar != undefined) {
                ...
                var toolbarRect = ostToolbar.getBoundingClientRect();
                var listItemEl = listItem === null || listItem === void 0 ? void 0 : listItem.getEl();
                var listItemElRect = listItemEl === null || listItemEl === void 0 ? void 0 : listItemEl.getBoundingClientRect();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    options = __assign({ blocks: [], block: function () { return ({}); }, usedOstBlocks: [], cmdOpenImport: "gjs-open-import-template", codeViewerTheme: "hopscotch", inlineCss: false, showStylesOnChange: true, showTraitsOnLoad: true, showOutlineOnLoad: true, t9n: _ostTranslations__WEBPACK_IMPORTED_MODULE_6__.ostTrans }, opts);
                    // Change some config
