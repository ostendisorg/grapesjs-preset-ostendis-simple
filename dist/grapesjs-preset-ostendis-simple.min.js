...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (function (editor, opts) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    function isBulletPoint(line) {
        ...
        return bulletPatterns.some(function (pattern) { return pattern.test(trimmedLine); });
    }
    ...
    return __generator(this, function (_a) {
        ...
        Commands.add("paste-from-word", {
            run: function (editor) {
                ...
                modal.open();
                setTimeout(function () {
                    var textarea = document.getElementById('word-paste-content');
                    var cancelBtn = document.getElementById('word-paste-cancel');
                    var applyBtn = document.getElementById('word-paste-apply');
                    if (textarea) {
                        textarea.focus();
                    }
                    if (cancelBtn) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    options = __assign({ blocks: [], block: function () { return ({}); }, usedOstBlocks: [], cmdOpenImport: "gjs-open-import-template", codeViewerTheme: "hopscotch", inlineCss: true, showStylesOnChange: true, showTraitsOnLoad: true, showOutlineOnLoad: true, t9n: _ostTranslations__WEBPACK_IMPORTED_MODULE_6__.ostTrans }, opts);
                    // Change some config
