        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    options = __assign({ blocks: [], block: function () { return ({}); }, cmdOpenImport: "gjs-open-import-template", cmdInlineHtml: "gjs-get-inlined-html", codeViewerTheme: "hopscotch", juiceOpts: {}, usedOstBlocks: [], inlineCss: true, updateStyleManager: true, showStylesOnChange: true, showBlocksOnLoad: false, showTraitsOnLoad: true, showOutlineOnLoad: true, t9n: _ostTranslations__WEBPACK_IMPORTED_MODULE_6__.ostTrans }, opts);
                    // Change some config
