...
const plugin = (editor_1, ...args_1) => __awaiter(void 0, [editor_1, ...args_1], void 0, function* (editor, opts = {}) {
    ...
    const options = Object.assign({ blocks: [], block: () => ({}), usedOstBlocks: [], cmdOpenImport: "gjs-open-import-template", codeViewerTheme: "hopscotch", inlineCss: true, showStylesOnChange: true, showTraitsOnLoad: true, showOutlineOnLoad: true, t9n: _ostTranslations__WEBPACK_IMPORTED_MODULE_6__.ostTrans }, opts);
    // Change some config
