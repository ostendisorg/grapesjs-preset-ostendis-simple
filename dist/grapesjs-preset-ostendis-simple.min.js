(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["grapesjs-preset-ostendis-simple"] = factory();
	else
		root["grapesjs-preset-ostendis-simple"] = factory();
            ...
            if (elInput !== null) {
                ...
                Array.from(element.options).forEach(function (optionElement, optionIndex) {
                    if (optionElement.value != "") {
                        var usedOstBlockTypesIndex = opts.usedOstBlockTypes.findIndex(function (e) { return e === optionElement.value; });
                        // Reset
                        var ele = elInput.querySelector("#" + [traitName]);
...
/* harmony import */ var _rte__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./rte */ "./src/rte.ts");
var __assign = (undefined && undefined.__assign) || function () {
    __assign = Object.assign || function(t) {
        for (var s, i = 1, n = arguments.length; i < n; i++) {
            s = arguments[i];
...
var plugin = function (editor_1) {
    ...
    return __awaiter(void 0, __spreadArray([editor_1], args_1, true), void 0, function (editor, opts) {
        ...
        function showOstToolbar(listItem) {
            var _a;
            var elPos = listItem === null || listItem === void 0 ? void 0 : listItem.index();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    options = __assign({ blocks: [], block: function () { return ({}); }, juiceOpts: {}, usedOstBlockTypes: [], cmdOpenImport: "gjs-open-import-template", cmdInlineHtml: "gjs-get-inlined-html", modalTitleImport: "Import template", modalTitleExport: "Export template", modalLabelImport: "", modalLabelExport: "", modalBtnImport: "Import", codeViewerTheme: "hopscotch", traitBlkValue: "", importPlaceholder: "", inlineCss: true, cellStyle: {
                            padding: "0",
                            margin: "0",
                            "vertical-align": "top",
                        }, tableStyle: {
                            ...
                            width: "100%",
                        }, updateStyleManager: true, showStylesOnChange: true, showBlocksOnLoad: false, showTraitsOnLoad: true, showOutlineOnLoad: true, ostToolbarClone: "Clone list element", ostToolbarDelete: "Delete list element", ostToolbarUp: "Move list element up", ostToolbarDown: "Move list element down", cmdBtnDesktopLabel: "Desktop", cmdBtnTabletLabel: "Tablet", cmdBtnMobileLabel: "Mobile", cmdBtnViewCompLabel: "View components", cmdBtnUndoLabel: "Undo", cmdBtnRedoLabel: "Redo", openTmBtnTitle: "Open Parameter" }, opts);
                    // Change some config
                ...
                case 1:
                    ...
                    return [4 /*yield*/, (0,_rte__WEBPACK_IMPORTED_MODULE_4__["default"])(editor, options)];
                case 2:
                    _a.sent();
